...
export default function TabTugasBelajar({ data, onViewDetail }: TabTugasBelajarProps) {
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse">
          ...
          <tbody>
            {paged.length === 0 ? (
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-sm text-gray-400 italic">Tidak ada data tugas belajar (dibebas tugaskan).</td>
              </tr>
            ) : (
              paged.map((d, i) => (
