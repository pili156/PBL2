    ...
    <>
      <FilterBar
        ...
        filters={[
          {
            label: "Jurusan",
            options: ["Semua Jurusan", "Teknik Elektro", "Teknik Informatika", "Teknik Sipil", "Teknik Mesin"],
            value: jurusan,
            onChange: setJurusan,
          },
          {
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse">
          ...
          <tbody>
            {paged.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-4 py-8 text-center text-sm text-gray-400 italic">Tidak ada data dosen.</td>
              </tr>
            ) : (
              paged.map((d, i) => (
